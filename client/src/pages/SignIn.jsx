        ...
        <Header className="shadow-md py-4 px-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <h5 className="text-xl font-bold">Muse Dashboard</h5>
            </div>

            {/* Navigation Section */}
            <div className="flex justify-center items-center mx-4">
              <Menu mode="horizontal" defaultSelectedKeys={["4"]} className="flex justify-center space-x-4">
                <Menu.Item key="1">
                  <Link to="/plans">
                    {/* {template} */}
                    <span>Plans</span>
            ...
            >
              ...
              <>
                ...
                <div style={{ textAlign: 'center', marginTop: '20px' }}>
                  <p style={{ color: '#666' }}>
                    Don't have an account?{' '}
                    <Link to="/sign-up" style={{ color: '#1890ff', fontWeight: 'bold' }}>
                      Register here
                    </Link>
                  </p>
                </div>
